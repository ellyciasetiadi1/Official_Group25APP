...
public class Indian_1 extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView indian1Title;
    private TextView indian1Ready;
    private TextView indian1Servings;
    private ImageView indian1Image;
    private TextView indian1Instructions;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/613255/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_indian_1);

        indian1Title = findViewById(R.id.indian1Title);
        indian1Ready = findViewById(R.id.indian1Ready);
        indian1Servings = findViewById(R.id.indian1Servings);
        indian1Image = findViewById(R.id.indian1Image);
        indian1Instructions = findViewById(R.id.indian1Instructions);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        indian1Title.setText(setTitle);
                        indian1Servings.setText(String.valueOf(setServings));
                        indian1Ready.setText(String.valueOf(setReady));
                        indian1Instructions.setText(setInstructions);
                        indian1Image.setImageResource(R.drawable.indian_1);
