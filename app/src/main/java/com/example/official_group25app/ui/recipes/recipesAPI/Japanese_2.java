...
public class Japanese_2 extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView jap2Title;
    private TextView jap2Ready;
    private TextView jap2Servings;
    private ImageView jap2Image;
    private TextView jap2Instructions;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/589863/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_japanese_2);

        jap2Title = findViewById(R.id.jap2Title);
        jap2Ready = findViewById(R.id.jap2Ready);
        jap2Servings = findViewById(R.id.jap2Servings);
        jap2Image = findViewById(R.id.jap2Image);
        jap2Instructions = findViewById(R.id.jap2Instructions);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        jap2Title.setText(setTitle);
                        jap2Servings.setText(String.valueOf(setServings));
                        jap2Ready.setText(String.valueOf(setReady));
                        jap2Instructions.setText(setInstructions);
                        jap2Image.setImageResource(R.drawable.jap_2);
