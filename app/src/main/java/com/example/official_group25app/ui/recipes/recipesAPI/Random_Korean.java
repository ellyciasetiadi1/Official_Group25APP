...
public class Random_Korean extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView randomKoreanTitle;
    private TextView randomKoreanReady;
    private TextView randomKoreanServings;
    private TextView randomKoreanInstructions;
    private ImageView korean4Image;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/478132/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_random__korean);

        randomKoreanTitle = findViewById(R.id.randomKoreanTitle);
        randomKoreanReady = findViewById(R.id.randomKoreanReady);
        randomKoreanServings = findViewById(R.id.randomKoreanServings);
        randomKoreanInstructions = findViewById(R.id.randomKoreanInstructions);
        korean4Image = findViewById(R.id.korean4Image);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        randomKoreanTitle.setText(setTitle);
                        randomKoreanServings.setText(String.valueOf(setServings));
                        randomKoreanReady.setText(String.valueOf(setReady));
                        randomKoreanInstructions.setText(setInstructions);
                        korean4Image.setImageResource(R.drawable.korean_4);
