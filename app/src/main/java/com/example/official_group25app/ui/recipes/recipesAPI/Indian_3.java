...
public class Indian_3 extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView indian3Title;
    private TextView indian3Ready;
    private TextView indian3Servings;
    private ImageView indian3Image;
    private TextView indian3Instructions;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/711310/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_indian_3);

        indian3Title = findViewById(R.id.indian3Title);
        indian3Ready = findViewById(R.id.indian3Ready);
        indian3Servings = findViewById(R.id.indian3Servings);
        indian3Image = findViewById(R.id.indian3Image);
        indian3Instructions = findViewById(R.id.indian3Instructions);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        indian3Title.setText(setTitle);
                        indian3Servings.setText(String.valueOf(setServings));
                        indian3Ready.setText(String.valueOf(setReady));
                        indian3Instructions.setText(setInstructions);
                        indian3Image.setImageResource(R.drawable.indian_3);
