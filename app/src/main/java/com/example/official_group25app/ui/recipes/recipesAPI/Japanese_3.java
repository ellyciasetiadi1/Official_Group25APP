...
public class Japanese_3 extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView jap3Title;
    private TextView jap3Ready;
    private TextView jap3Servings;
    private ImageView jap3Image;
    private TextView jap3Instructions;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/553216/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_japanese_3);

        jap3Title = findViewById(R.id.jap3Title);
        jap3Ready = findViewById(R.id.jap3Ready);
        jap3Servings = findViewById(R.id.jap3Servings);
        jap3Image = findViewById(R.id.jap3Image);
        jap3Instructions = findViewById(R.id.jap3Instructions);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        jap3Title.setText(setTitle);
                        jap3Servings.setText(String.valueOf(setServings));
                        jap3Ready.setText(String.valueOf(setReady));
                        jap3Instructions.setText(setInstructions);
                        jap3Image.setImageResource(R.drawable.jap_3);
