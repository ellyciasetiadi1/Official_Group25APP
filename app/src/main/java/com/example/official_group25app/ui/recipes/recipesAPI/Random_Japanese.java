...
public class Random_Japanese extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView randomJapaneseTitle;
    private TextView randomJapaneseReady;
    private TextView randomJapaneseServings;
    private TextView randomJapaneseInstructions;
    private ImageView japanese4Image;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/228441/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_random__japanese);

        randomJapaneseTitle = findViewById(R.id.randomJapaneseTitle);
        randomJapaneseReady = findViewById(R.id.randomJapaneseReady);
        randomJapaneseServings = findViewById(R.id.randomJapaneseServings);
        randomJapaneseInstructions = findViewById(R.id.randomJapaneseInstructions);
        japanese4Image = findViewById(R.id.japanese4Image);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        randomJapaneseTitle.setText(setTitle);
                        randomJapaneseServings.setText(String.valueOf(setServings));
                        randomJapaneseReady.setText(String.valueOf(setReady));
                        randomJapaneseInstructions.setText(setInstructions);
                        japanese4Image.setImageResource(R.drawable.japanese_4);
