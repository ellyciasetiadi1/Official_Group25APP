...
public class Korean_2 extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView korean2Title;
    private TextView korean2Ready;
    private TextView korean2Servings;
    private ImageView korean2Image;
    private TextView korean2Instructions;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/610628/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_korean_2);

        korean2Title = findViewById(R.id.korean2Title);
        korean2Ready = findViewById(R.id.korean2Ready);
        korean2Servings = findViewById(R.id.korean2Servings);
        korean2Image = findViewById(R.id.korean2Image);
        korean2Instructions = findViewById(R.id.korean2Instructions);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        korean2Title.setText(setTitle);
                        korean2Servings.setText(String.valueOf(setServings));
                        korean2Ready.setText(String.valueOf(setReady));
                        korean2Instructions.setText(setInstructions);
                        korean2Image.setImageResource(R.drawable.korean_2);
