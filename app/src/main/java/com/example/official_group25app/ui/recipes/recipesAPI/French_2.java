...
public class French_2 extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView french2Title;
    private TextView french2Ready;
    private TextView french2Servings;
    private ImageView french2Image;
    private TextView french2Instructions;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/992952/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_french_2);

        french2Title = findViewById(R.id.french2Title);
        french2Ready = findViewById(R.id.french2Ready);
        french2Servings = findViewById(R.id.french2Servings);
        french2Image = findViewById(R.id.french2Image);
        french2Instructions = findViewById(R.id.french2Instructions);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        french2Title.setText(setTitle);
                        french2Servings.setText(String.valueOf(setServings));
                        french2Ready.setText(String.valueOf(setReady));
                        french2Instructions.setText(setInstructions);
                        french2Image.setImageResource(R.drawable.french_2);
