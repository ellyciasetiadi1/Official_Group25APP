...
public class Indian_2 extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView indian2Title;
    private TextView indian2Ready;
    private TextView indian2Servings;
    private ImageView indian2Image;
    private TextView indian2Instructions;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/1007841/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_indian_2);

        indian2Title = findViewById(R.id.indian2Title);
        indian2Ready = findViewById(R.id.indian2Ready);
        indian2Servings = findViewById(R.id.indian2Servings);
        indian2Image = findViewById(R.id.indian2Image);
        indian2Instructions = findViewById(R.id.indian2Instructions);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        indian2Title.setText(setTitle);
                        indian2Servings.setText(String.valueOf(setServings));
                        indian2Ready.setText(String.valueOf(setReady));
                        indian2Instructions.setText(setInstructions);
                        indian2Image.setImageResource(R.drawable.indian_2);
