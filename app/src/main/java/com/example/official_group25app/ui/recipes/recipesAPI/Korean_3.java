...
public class Korean_3 extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView korean3Title;
    private TextView korean3Ready;
    private TextView korean3Servings;
    private ImageView korean3Image;
    private TextView korean3Instructions;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/196275/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_korean_3);

        korean3Title = findViewById(R.id.korean3Title);
        korean3Ready = findViewById(R.id.korean3Ready);
        korean3Servings = findViewById(R.id.korean3Servings);
        korean3Image = findViewById(R.id.korean3Image);
        korean3Instructions = findViewById(R.id.korean3Instructions);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        korean3Title.setText(setTitle);
                        korean3Servings.setText(String.valueOf(setServings));
                        korean3Ready.setText(String.valueOf(setReady));
                        korean3Instructions.setText(setInstructions);
                        korean3Image.setImageResource(R.drawable.korean_3);
