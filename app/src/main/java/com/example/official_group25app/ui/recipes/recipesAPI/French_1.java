...
public class French_1 extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView french1Title;
    private TextView french1Ready;
    private TextView french1Servings;
    private ImageView french1Image;
    private TextView french1Instructions;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/551441/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_french_1);

        french1Title = findViewById(R.id.french1Title);
        french1Ready = findViewById(R.id.french1Ready);
        french1Servings = findViewById(R.id.french1Servings);
        french1Image = findViewById(R.id.french1Image);
        french1Instructions = findViewById(R.id.french1Instructions);
        ...
        */
        ...
        // This creates a request queue. Volley is essentially a HTTP library that we chose to use because it makes networking for Android apps
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        french1Title.setText(setTitle);
                        french1Servings.setText(String.valueOf(setServings));
                        french1Ready.setText(String.valueOf(setReady));
                        french1Instructions.setText(setInstructions);
                        french1Image.setImageResource(R.drawable.french_1);
