...
public class Random_French extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView randomFrenchTitle;
    private TextView randomFrenchReady;
    private TextView randomFrenchServings;
    private TextView randomFrenchInstructions;
    private ImageView french4Image;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/1073533/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_random__french);

        randomFrenchTitle = findViewById(R.id.randomFrenchTitle);
        randomFrenchReady = findViewById(R.id.randomFrenchReady);
        randomFrenchServings = findViewById(R.id.randomFrenchServings);
        randomFrenchInstructions = findViewById(R.id.randomFrenchInstructions);
        french4Image = findViewById(R.id.french4Image);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        randomFrenchTitle.setText(setTitle);
                        randomFrenchServings.setText(String.valueOf(setServings));
                        randomFrenchReady.setText(String.valueOf(setReady));
                        randomFrenchInstructions.setText(setInstructions);
                        french4Image.setImageResource(R.drawable.french_4);
