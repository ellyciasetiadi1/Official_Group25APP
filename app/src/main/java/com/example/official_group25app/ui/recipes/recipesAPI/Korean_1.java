...
public class Korean_1 extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView korean1Title;
    private TextView korean1Ready;
    private TextView korean1Servings;
    private ImageView korean1Image;
    private TextView korean1Instructions;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/755321/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_korean_1);

        korean1Title = findViewById(R.id.korean1Title);
        korean1Ready = findViewById(R.id.korean1Ready);
        korean1Servings = findViewById(R.id.korean1Servings);
        korean1Image = findViewById(R.id.korean1Image);
        korean1Instructions = findViewById(R.id.korean1Instructions);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        korean1Title.setText(setTitle);
                        korean1Servings.setText(String.valueOf(setServings));
                        korean1Ready.setText(String.valueOf(setReady));
                        korean1Instructions.setText(setInstructions);
                        korean1Image.setImageResource(R.drawable.korean_1);
