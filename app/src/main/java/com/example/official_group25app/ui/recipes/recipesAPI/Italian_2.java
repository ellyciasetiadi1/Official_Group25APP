...
public class Italian_2 extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView italian2Title;
    private TextView italian2Ready;
    private TextView italian2Servings;
    private ImageView italian2Image;
    private TextView italian2Instructions;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/698864/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_italian_2);

        italian2Title = findViewById(R.id.italian2Title);
        italian2Ready = findViewById(R.id.italian2Ready);
        italian2Servings = findViewById(R.id.italian2Servings);
        italian2Image = findViewById(R.id.italian2Image);
        italian2Instructions = findViewById(R.id.italian2Instructions);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        italian2Title.setText(setTitle);
                        italian2Servings.setText(String.valueOf(setServings));
                        italian2Ready.setText(String.valueOf(setReady));
                        italian2Instructions.setText(setInstructions);
                        italian2Image.setImageResource(R.drawable.italian_2);
