...
public class Random_Indian extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView randomIndianTitle;
    private TextView randomIndianReady;
    private TextView randomIndianServings;
    private TextView randomIndianInstructions;
    private ImageView indian4Image;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/198223/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_random__indian);

        randomIndianTitle = findViewById(R.id.randomIndianTitle);
        randomIndianReady = findViewById(R.id.randomIndianReady);
        randomIndianServings = findViewById(R.id.randomIndianServings);
        randomIndianInstructions = findViewById(R.id.randomIndianInstructions);
        indian4Image = findViewById(R.id.indian4Image);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        randomIndianTitle.setText(setTitle);
                        randomIndianServings.setText(String.valueOf(setServings));
                        randomIndianReady.setText(String.valueOf(setReady));
                        randomIndianInstructions.setText(setInstructions);
                        indian4Image.setImageResource(R.drawable.indian_4);
