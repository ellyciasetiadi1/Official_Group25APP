...
public class Random_Italian extends AppCompatActivity {

    public static final String EXTRA_MESSAGE = "com.example.group25app.MESSAGE";
    private TextView randomItalianTitle;
    private TextView randomItalianReady;
    private TextView randomItalianServings;
    private TextView randomItalianInstructions;
    private ImageView italian4Image;

    // The URL link used to retrieve API data is from Spoonacular
    String URL = "https://api.spoonacular.com/recipes/1104402/information?includeNutrition=false&apiKey=1c3106a2562b46c6b0e545f70a9252b8";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_random__italian);

        randomItalianTitle = findViewById(R.id.randomItalianTitle);
        randomItalianReady = findViewById(R.id.randomItalianReady);
        randomItalianServings = findViewById(R.id.randomItalianServings);
        randomItalianInstructions = findViewById(R.id.randomItalianInstructions);
        italian4Image = findViewById(R.id.italian4Image);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        randomItalianTitle.setText(setTitle);
                        randomItalianServings.setText(String.valueOf(setServings));
                        randomItalianReady.setText(String.valueOf(setReady));
                        randomItalianInstructions.setText(setInstructions);
                        italian4Image.setImageResource(R.drawable.italian_4);
